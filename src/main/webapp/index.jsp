...
<html>
	<head>
		<title>Sysfoo Demo app from  Motorrad</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						...
						<!-- About -->
							<article id="about">
								...
								<p>Cloud. To learn more visit Motorrad.</p>
							</article>
					</div>

				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copycopyrights; Designed by Motorrad @2020-21</a>.</p>
					</footer>
